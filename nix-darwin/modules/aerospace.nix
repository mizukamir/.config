...

{
  xdg.configFile."aerospace/aerospace.toml".text = ''
    ...
    '/bin/bash',
    '-c',
'/run/current-system/sw/bin/sketchybar --trigger aerospace_workspace_change AEROSPACE_FOCUSED_WORKSPACE=$AEROSPACE_FOCUSED_WORKSPACE AEROSPACE_PREV_WORKSPACE=$AEROSPACE_PREV_WORKSPACE && toggle-autoraise'
    ]
    ...
    [mode.main.binding]
        ...
        alt-f = ['layout floating tiling', 'exec-and-forget']       
        ...
        alt-shift-backspace = 'exec-and-forget ~/.config/sketchybar/plugins/toggle_desktop.sh'

    [mode.service.binding]
        esc = ['reload-config', 'mode main']
        r = ['flatten-workspace-tree', 'mode main']
        f = ['layout floating tiling', 'mode main']
        backspace = ['close-all-windows-but-current', 'mode main', 'exec-and-forget']
